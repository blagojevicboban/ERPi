...
namespace ERPiData.Migrations
{
    ...
    [Migration("20260807141118_DodajKontoDobavljacaUMaloprodajneKalkulacije")]
    partial class DodajKontoDobavljacaUMaloprodajneKalkulacije
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERPiData.Models.Core.DokumentPrilog", b =>
                {
            ...
            modelBuilder.Entity("ERPiData.Models.Finansije.PdvZapis", b =>
                {
                    ...
                    b.Property<int?>("IzvornoDokumentId")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("OslobodjenPromet")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("Osnovica10")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("Osnovica20")
                        .HasColumnType("TEXT");

                    b.Property<string>("PartnerNaziv")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("PartnerPib")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<decimal>("Pdv10")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("Pdv20")
                        .HasColumnType("TEXT");

                    b.Property<int>("RedniBroj")
                        .HasColumnType("INTEGER");

                    b.Property<int>("TipKnjige")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("UkupnaNaknadaSaPdv")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ERPiData.Models.Magacin.RacunOtpremnicaStavka", b =>
                {
                    ...
                    b.Property<string>("JedinicaMereUsluge")
                        .HasMaxLength(20)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.ClanKomisije", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.Kartica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SredstvaKartice");
                });

            modelBuilder.Entity("ERPiData.Models.Sredstva.Komisija", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.Popis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("KomisijaId", "Godina");

                    b.ToTable("Popisi");
                });

            modelBuilder.Entity("ERPiData.Models.Sredstva.PopisnaStavka", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.Prijava", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SredstvaPrijave");
                });

            modelBuilder.Entity("ERPiData.Models.Sredstva.Rashod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SredstvaRashodi");
                });

            modelBuilder.Entity("ERPiData.Models.Sredstva.Sredstvo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ERPiData.Models.Magacin.MaloprodajnaKalkulacija", b =>
                {
                    b.HasOne("ERPiData.Models.Core.Partner", "Dobavljac")
                        .WithMany()
            ...
            modelBuilder.Entity("ERPiData.Models.Magacin.PrimopredajaStavka", b =>
                {
                    b.HasOne("ERPiData.Models.Magacin.Materijal", "Materijal")
                        .WithMany()
            ...
            modelBuilder.Entity("ERPiData.Models.Magacin.RacunOtpremnica", b =>
                {
                    b.HasOne("ERPiData.Models.Core.Konto", "KontoKupca")
                        .WithMany()
                        .HasForeignKey("KontoKupcaId");
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.ClanKomisije", b =>
                {
                    b.HasOne("ERPiData.Models.Sredstva.Komisija", "Komisija")
                        .WithMany("Clanovi")
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.Kartica", b =>
                {
                    ...
                    b.HasOne("ERPiData.Models.Sredstva.Sredstvo", "Sredstvo")
                        .WithMany("Kartice")
            ...
            modelBuilder.Entity("ERPiData.Models.Sredstva.PopisnaStavka", b =>
                {
                    b.HasOne("ERPiData.Models.Sredstva.Popis", "Popis")
                        .WithMany("Stavke")
