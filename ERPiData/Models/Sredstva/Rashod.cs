...
/// <summary>Odgovara RASHOD.DBF — nalog za promenu/rashod osnovnog sredstva. Port iz ERPiSredstvaData.Models.Rashod, bez izmena (nema string reference ka drugim modulima).</summary>
public class Rashod
{
