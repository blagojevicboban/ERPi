...
public class Doprinos
{
    ...
    [Column(TypeName = "decimal(6,3)")] public decimal ProcRadn { get; set; }
    [Column(TypeName = "decimal(6,3)")] public decimal ProcPosl { get; set; }
    [Column(TypeName = "decimal(6,3)")] public decimal B60ProcR { get; set; }
    [Column(TypeName = "decimal(6,3)")] public decimal B60ProcP { get; set; }
    [Column(TypeName = "decimal(6,2)")] public decimal Bp60ProcP { get; set; }
    [Column(TypeName = "decimal(6,2)")] public decimal Bp60FProcP { get; set; }
    [Column(TypeName = "decimal(6,2)")] public decimal PorProcP { get; set; }
    [Column(TypeName = "decimal(6,2)")] public decimal NepProcP { get; set; }
    [Column(TypeName = "decimal(6,2)")] public decimal InvProcP { get; set; }
    ...
    [MaxLength(40)] public string ZiroRacun { get; set; } = "";
    [MaxLength(40)] public string ZiroRacP { get; set; } = "";
    [MaxLength(30)] public string PozivNaB { get; set; } = "";
    [MaxLength(30)] public string PozivNa2 { get; set; } = "";
    [MaxLength(10)] public string SifPlac { get; set; } = "";
    [MaxLength(10)] public string SifPlacP { get; set; } = "";

    [Column(TypeName = "decimal(14,2)")] public decimal NajnizaOsnovica { get; set; }
    [Column(TypeName = "decimal(14,2)")] public decimal NajvisaOsnovica { get; set; }
}
