...
public static class VerzijeObracunaService
{
    ...
    public static int Arhiviraj(ErpiDbContext db, IEnumerable<ObracunPlate> obracuni, string razlog)
    {
    ...
    public static int SledecaVerzija(
        ErpiDbContext db, int godina, int mesec, int radnikId, Isplata? isplata = null)
    {
