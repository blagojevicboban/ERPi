...
public static class KreditRateService
{
    ...
    /// </summary>
    private static bool NosiObustave(ErpiDbContext db, ObracunPlate obracun)
    {
    ...
    public static int VratiRate(ErpiDbContext db, ObracunPlate obracun)
    {
    ...
    public static int SkiniRate(ErpiDbContext db, ObracunPlate obracun)
    {
        if (!NosiObustave(db, obracun)) return 0;
