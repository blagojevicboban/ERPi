...
namespace ERPiApp.Views.Zarade.Isplate;
...
public class IsplataRed
{
    ...
    public string VrstaNaziv => ERPiData.Models.Zarade.Isplata.NazivVrste(Isplata.Vrsta);
...
public sealed class VrstaIsplateStavka
{
    ...
    public string Naziv => ERPiData.Models.Zarade.Isplata.NazivVrste(Vrsta);
}
