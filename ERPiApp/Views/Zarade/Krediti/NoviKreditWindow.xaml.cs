...
namespace ERPiApp.Views.Zarade.Krediti;
...
public partial class NoviKreditWindow : Window
{
    ...
    public NoviKreditWindow(Radnik radnik, Kredit? kredit = null)
    {
        ...
        KeyDown += (s, e) => { if (e.Key == System.Windows.Input.Key.F1) { new ERPiApp.Views.Zarade.Pomoc.EditHelpWindow("Unos / izmena kredita", "Evidencija rata i obustava kredita", new[] { ("Enter", "Sačuvaj kredit"), ("Esc", "Zatvori prozor") }, "Unesite iznos i broj rata — mesečna rata se preračunava.").ShowDialog(); e.Handled = true; } };
