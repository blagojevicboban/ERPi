...
namespace ERPiApp.Views.Zarade.VrstePrimanja;
...
public partial class VrstePrimanjaPage : Page
{
    ...
    {
        var servis = new ERPiApp.Services.Zarade.PrevodStavkiService(_db);

        ERPiApp.Services.Zarade.PrevodRezultat proba;
        try
        {
    ...
    private void BtnSacuvaj_Click(object sender, RoutedEventArgs e)
    {
        ...
        var neispravanSvp = _vrste.FirstOrDefault(v =>
            !string.IsNullOrWhiteSpace(v.Svp) && !ERPiApp.Services.Zarade.SvpService.JeSvpSifra(v.Svp.Trim()));
