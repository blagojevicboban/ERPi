...
namespace ERPiApp.Views.Zarade.PppPo;
...
public partial class PppPoPage : Page
{
    ...
    private ERPiData.Models.Core.Firma? UcitajFirmu() => _db.Firme.FirstOrDefault();
    ...
    private void BtnJedan_Click(object sender, RoutedEventArgs e)
    {
        ...
        Izvrsi(() =>
        {
            PppPoDocument.Sacuvaj(obrazac, UcitajFirmu(), sfd.FileName);
    ...
    private void BtnSvi_Click(object sender, RoutedEventArgs e)
    {
        ...
        Izvrsi(() =>
        {
            PppPoDocument.Sacuvaj(_rezultat.Obrasci, UcitajFirmu(), sfd.FileName);
